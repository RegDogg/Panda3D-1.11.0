...
Installing Panda3D Miles
==================

The latest Panda3D can be downloaded from
[this page](https://dl.broadwaypixels.com/Panda3D-1.11.0.exe).
...
Building Panda3D Miles
================

Windows
-------

Should be the same, if not let me know. :)
...
the build scripts to use. After acquiring these dependencies, you may simply build Panda3D from the
